...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriverService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Vehicle/Entity')], true)), 'App\\Domain\\Vehicle\\Entity');
    ...
    {
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Vehicle/Entity')], true);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setEntityNamespaces(['Vehicle' => 'App\\Domain\\Vehicle\\Entity']);
