...
class getLexikJwtAuthentication_KeyLoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader((\dirname(__DIR__, 3).'/jwt/private.pem'), (\dirname(__DIR__, 3).'/jwt/public.pem'), $container->getEnv('JWT_PASSPHRASE'), []);
    }
}
